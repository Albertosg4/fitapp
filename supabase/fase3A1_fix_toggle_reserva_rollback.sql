-- ============================================================
-- JGS Fight Team — Fase 3A1 rollback
-- Archivo: supabase/fase3A1_fix_toggle_reserva_rollback.sql
--
-- Restaura la versión previa de toggle_reserva (sin v_reserva_existe).
-- ============================================================
